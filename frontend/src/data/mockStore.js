/**
 * Données mockées partagées par les espaces professeur et élève.
 *
 * Les noms de champs suivent le modèle backend (cours / seance / eleve /
 * question / contenu) pour que la couche services/ puisse être branchée sur
 * la vraie API sans changer les noms utilisés par les vues.
 * "classe" (vocabulaire UI professeur) == entité "cours".
 */
...
export const ELEVE_ACTUEL_ID = 13
export const PROFESSEUR_ACTUEL_ID = 1

export const professeurs = [{ id: 1, nom: 'Camille Dubois', email: 'camille.dubois@ecole.fr' }]
...
export const questions = [
  ...
  },
  {
    ...
    eleve_id: 1,
    texte:
      "Je ne comprends pas pourquoi la limite d'une suite géométrique de raison négative n'existe pas toujours.",
...
// Pool de questions "en attente" injectées à intervalle régulier pour
// préfigurer un flux WebSocket (regroupées avec les questions 1 et 3
// ci-dessus, même thématique, pour démontrer le regroupement par similarité).
...
export const notionsDifficulte = [
  ...
  { eleve_id: 5, seance_id: 3, notion: 'Suites majorées / convergence', date: atHour(-14, 9, 30) },
  {
    eleve_id: 9,
    seance_id: 6,
    notion: "Taux d'accroissement vs nombre dérivé",
    date: atHour(-5, 14, 15),
  },
  {
    eleve_id: 13,
    seance_id: 7,
    notion: "Équation cartésienne d'un plan",
    date: addMinutes(now, -9).toISOString(),
  },
]

export const synthesesQuestions = []
export const synthesesCours = []

export const SYNTHESE_TEMPLATES = [
